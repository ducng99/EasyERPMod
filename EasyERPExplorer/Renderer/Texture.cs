...
namespace EasyERPExplorer.Renderer
{
    ...
    class Texture : IDisposable
    {
        ...
        public Texture(string name, Bitmap image, bool generateMipmaps, bool srgb)
        {
            ...
            RenderUtils.CheckGLError("Clear");

            RenderUtils.CreateTexture(TextureTarget.Texture2D, Name, out GLTexture);
            ...
            RenderUtils.CheckGLError("Filtering");
        ...
        public void SetAnisotropy(float level)
        {
            ...
            GL.TextureParameter(GLTexture, TEXTURE_MAX_ANISOTROPY, RenderUtils.Clamp(level, 1, MaxAniso));
        }
