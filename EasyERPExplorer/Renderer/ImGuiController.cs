...
namespace EasyERPExplorer.Renderer
{
    ...
    public class ImGuiController : IDisposable
    {
        ...
        {
            RenderUtils.CreateVertexArray("ImGui", out _vertexArray);

            _vertexBufferSize = 10000;
            _indexBufferSize = 2000;

            RenderUtils.CreateVertexBuffer("ImGui", out _vertexBuffer);
            RenderUtils.CreateElementBuffer("ImGui", out _indexBuffer);
...
void main()
{
    outputColor = color * texture(in_fontTexture, texCoord);
            ...
            RenderUtils.CheckGLError("End of ImGui setup");
        }
        ...
        private void RenderImDrawData(ImDrawDataPtr draw_data)
        {
            ...
            RenderUtils.CheckGLError("Projection");

            GL.BindVertexArray(_vertexArray);
            RenderUtils.CheckGLError("VAO");
            ...
            for (int n = 0; n < draw_data.CmdListsCount; n++)
            {
                ...
                for (int cmd_i = 0; cmd_i < cmd_list.CmdBuffer.Size; cmd_i++)
                {
                    ...
                    else
                    {
                        ...
                        RenderUtils.CheckGLError("Texture");

                        // We do _windowHeight - (int)clip.W instead of (int)clip.Y because gl has flipped Y when it comes to these coordinates
                        var clip = pcmd.ClipRect;
                        GL.Scissor((int)clip.X, _windowHeight - (int)clip.W, (int)(clip.Z - clip.X), (int)(clip.W - clip.Y));
                        RenderUtils.CheckGLError("Scissor");
